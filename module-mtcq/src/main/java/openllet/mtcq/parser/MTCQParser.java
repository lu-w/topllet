...
public class MTCQParser extends Parser {
	...
	public static final int
		...
		RI_TERMINAL=16, R_TERMINAL=17, FI_TERMINAL=18, F_TERMINAL=19, GI_TERMINAL=20, 
		G_TERMINAL=21, LAST_TERMINAL=22, END_TERMINAL=23, NOT1_TERMINAL=24, NOT2_TERMINAL=25, 
		AND1_TERMINAL=26, AND2_TERMINAL=27, OR1_TERMINAL=28, OR2_TERMINAL=29, 
		IMPL1_TERMINAL=30, IMPL2_TERMINAL=31, EQUIV1_TERMINAL=32, EQUIV2_TERMINAL=33, 
		XOR_TERMINAL=34, TRUE_TERMINAL=35, FALSE_TERMINAL=36, TT_TERMINAL=37, 
		FF_TERMINAL=38, TIME_POINT=39, NAME=40, URI=41, COMMENT=42, WS=43;
	public static final int
		...
		RULE_next = 14, RULE_until = 15, RULE_release = 16, RULE_eventually = 17, 
		RULE_globally = 18, RULE_term = 19, RULE_subject = 20, RULE_role_atom = 21, 
		RULE_concept_atom = 22, RULE_atom = 23, RULE_conjunctive_query = 24, RULE_mtcq_formula = 25, 
		RULE_prefix = 26, RULE_start = 27;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"release", "eventually", "globally", "term", "subject", "role_atom", 
			"concept_atom", "atom", "conjunctive_query", "mtcq_formula", "prefix", 
			"start"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"X_TERMINAL", "XB_TERMINAL", "UI_TERMINAL", "U_TERMINAL", "RI_TERMINAL", 
			"R_TERMINAL", "FI_TERMINAL", "F_TERMINAL", "GI_TERMINAL", "G_TERMINAL", 
			"LAST_TERMINAL", "END_TERMINAL", "NOT1_TERMINAL", "NOT2_TERMINAL", "AND1_TERMINAL", 
			"AND2_TERMINAL", "OR1_TERMINAL", "OR2_TERMINAL", "IMPL1_TERMINAL", "IMPL2_TERMINAL", 
			"EQUIV1_TERMINAL", "EQUIV2_TERMINAL", "XOR_TERMINAL", "TRUE_TERMINAL", 
			"FALSE_TERMINAL", "TT_TERMINAL", "FF_TERMINAL", "TIME_POINT", "NAME", 
			"URI", "COMMENT", "WS"
		};
	}
	...
	public static class ReleaseContext extends ParserRuleContext {
		public TerminalNode R_TERMINAL() { return getToken(MTCQParser.R_TERMINAL, 0); }
		public TerminalNode RI_TERMINAL() { return getToken(MTCQParser.RI_TERMINAL, 0); }
		public IntervalContext interval() {
			return getRuleContext(IntervalContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MTCQListener ) ((MTCQListener)listener).enterRelease(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MTCQListener ) ((MTCQListener)listener).exitRelease(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MTCQVisitor ) return ((MTCQVisitor<? extends T>)visitor).visitRelease(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ReleaseContext release() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_release);
		try {
			setState(103);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final GloballyContext globally() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_globally);
		try {
			setState(113);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final SubjectContext subject() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_subject);
		try {
			setState(127);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Role_atomContext role_atom() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_role_atom);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(129);
	...
	public final Concept_atomContext concept_atom() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_concept_atom);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(136);
	...
	public final Conjunctive_queryContext conjunctive_query() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_conjunctive_query);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ReleaseFormulaContext extends Mtcq_formulaContext {
		public List<Mtcq_formulaContext> mtcq_formula() {
			return getRuleContexts(Mtcq_formulaContext.class);
		}
		public Mtcq_formulaContext mtcq_formula(int i) {
		...
		public ReleaseFormulaContext(Mtcq_formulaContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MTCQListener ) ((MTCQListener)listener).enterReleaseFormula(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MTCQListener ) ((MTCQListener)listener).exitReleaseFormula(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MTCQVisitor ) return ((MTCQVisitor<? extends T>)visitor).visitReleaseFormula(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private Mtcq_formulaContext mtcq_formula(int _p) throws RecognitionException {
		...
		int _startState = 50;
		enterRecursionRule(_localctx, 50, RULE_mtcq_formula, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						{
						_localctx = new ReleaseFormulaContext(new Mtcq_formulaContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_mtcq_formula);
						setState(184);
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3813997818176L) != 0)) {
				{
				setState(228);
				mtcq_formula(0);
				}
